...
export default class DatePicker {
    ...
    render() {
        return (
            <div className="datePicker" style={{ left: '66.6%' }}>
                <div className="datePicker-header"  style={{ width: '33.3%', left: '66.6%' }}>
                ...
                <div className="grid"  style={{ width: '33.3%', left: '66.6%' }}>
                    <div className="fix-part"  style={{ width: '33.3%', left: '66.6%' }}>
                        ...
                        <div className="calender-title" style={{ width: '33.3%', left: '66.6%' }}>
